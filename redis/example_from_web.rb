# From: 
#     [web]
#     [http://webcache.googleusercontent.com/search?q=cache:uhyN-Mchq3EJ:workharderplayharder.com/rouge+connect+to+redis+server+ruby+tcpsocket&cd=2&hl=en&ct=clnk&gl=us&client=firefox-a&source=www.google.com]

#Ruby is just fun

#After playing with ohm that comes with monk for sinatra (If you don't know what I'm talking about, shame on you) I decided I wasn't a fanboy. For me, the whole point of putting stuff in a database is being able to get it out. But unlike a cookie jar, we don't want to just stick our pinkies in and pull out the first one that wants to leave.

#So, its not hugely featured, but it does stand on the shoulders of the awesome redis sort command to provide a compellingly simple way to query data ... more to follow (I have a day job, so give me a break :-) )
